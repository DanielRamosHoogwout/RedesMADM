...
# ??? CUANDO JAIRO HOY HABLABA DE DISTRIBUCIONES DE GRADOS HA ESTADO TRABAJANDO CON SUS DISTRIBUCIONES DE PROBABILIDAD, YO PONDRÍA EL GRÁFICO DE MÁS ABAJO
```
...
# ???? NECESARIO HACERLO TAMBIÉN CON 10?
```
...
En este caso no parece que los grados sigan una recta. Hay muchos valores que son 0 o 0.001 debido a que hay muy pocos nodos de grado mayor de 13, pero si el grafo fuera mayor a lo mejor se seguiría viendo la relación lineal.
...
```{r}
# LO DEJO COMENTADO PORQUE AL HACER KNIT DA ERROR, LMI NO EXISTE PORQUE JAIRO HA PUESTO EL CHUNK DEL APARTADO C EN EVAL=FALSE
#alpha = -LMI[[2]]
#alpha
# ????? EL EXPONENTE EL EL COEFICIENTE DE LA RECTA DE REGRESIÓN, PERO HAY QUE HACER OTRA VEZ LA REGRESIÓN CON TODOS LOS GRADOS? ANTES SE HAN OMITIDO LOS GRADOS MENORES DE 10
```
