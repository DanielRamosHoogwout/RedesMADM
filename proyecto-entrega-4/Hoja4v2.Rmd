...
# Creamos el gráfico
plot <- ggplot(count) +
  geom_line(aes(x = seq(nrow(count)), y = count_b.s), color = "blue", lwd = 1, linetype = "dotted") +
  geom_line(aes(x = seq(nrow(count)), y = count_b.x), color = "red", lwd = 1, linetype = "dotted") +
  geom_line(aes(x = seq(nrow(count)), y = count_b.r), color = "forestgreen", lwd = 1, linetype = "dotted") +
  geom_line(aes(x = seq(nrow(count)), y = count_B.s), color = "blue", lwd = 1, linetype = "dashed") +
  geom_line(aes(x = seq(nrow(count)), y = count_B.x), color = "red", lwd = 1, linetype = "dashed") +
  geom_line(aes(x = seq(nrow(count)), y = count_B.r), color = "forestgreen", lwd = 1, linetype = "dashed") +
  geom_line(aes(x = seq(nrow(count)), y = count.s), color = "blue", lwd = 1) +
  geom_line(aes(x = seq(nrow(count)), y = count.x), color = "red", lwd = 1) +
  geom_line(aes(x = seq(nrow(count)), y = count.r), color = "forestgreen", lwd = 1) +
...
ndeg_dist <- data_frame(deg = seq(0,length(degree_distribution(ngf))-1), prob = degree_distribution(ngf)) %>%
  filter(prob > 0)
